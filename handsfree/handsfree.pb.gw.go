...
var filter_HandsfreeService_Connect_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func RegisterHandsfreeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HandsfreeServiceServer) error {
	mux.Handle(http.MethodPost, pattern_HandsfreeService_Send_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodGet, pattern_HandsfreeService_Connect_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
// "HandsfreeServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
